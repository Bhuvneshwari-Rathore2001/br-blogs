const SearchIcon = ({ height = 20, width = 20 }) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      <mask
        ...
        height="20"
      >
        <rect width="20" height="20" fill="url(#pattern0_55_2118)" />
      </mask>
      <g mask="url(#mask0_55_2118)">
      ...
      <defs>
        <pattern
          ...
          height="1"
        >
          <use xlinkHref="#image0_55_2118" transform="scale(0.0333333)" />
        </pattern>
        <image
          id="image0_55_2118"
          width="30"
